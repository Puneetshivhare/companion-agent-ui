...
export default function CTA() {
  return (
    <section className="bg-canvasSoft px-6 py-24 text-center">
      <div className="mx-auto max-w-content">
        <h2 className="text-[28px] font-light tracking-tight text-ink">
          Curious how {content.projectName} works under the hood?
        </h2>
        <p className="mx-auto mt-3 max-w-[480px] text-[14px] text-copy">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-full bg-ink px-6 py-3 text-[13px] font-medium text-white transition-transform duration-300 ease-out hover:scale-[1.04]"
          >
